...
3. If you've completed previous steps successfully, you can run do `docker-compose up` in `docker` directory to start things. Logs are dumped to terminal screen.
4. You can access the app from http://localhost:9080/mapbrowser . 

To perform these steps, you'll need Node 10.15 LTS, Java 9 and Docker 18.02 or newer.
